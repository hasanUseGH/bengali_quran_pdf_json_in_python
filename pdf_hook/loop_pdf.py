...
# Loop through sura_1.json to sura_114.json
for sura_number in range(1, 115):
    # Construct the path for each JSON file dynamically
    json_path = f"C:\\Users\\Hasan\\Desktop\\py_quran\\files\\sura_jsons\\sura_{sura_number}.json"
    ...
    def generate_pdf(sura_number):
        with sync_playwright() as p:
            ...
            page.pdf(
                path=f"bn_pdf/sura_{sura_number}.pdf",  # Use dynamic filename based on sura_number
                format="A4",
    ...
    # Call the generate_pdf function for each sura
    generate_pdf(sura_number)
    print(f"PDF for Sura {sura_number} generated successfully!")
